        ...
        <div className="flex flex-col items-center gap-8 text-center md:items-start md:text-left">
          <div className="flex flex-col gap-4">
            <h1 className="text-4xl font-black tracking-tighter text-text-light dark:text-text-dark sm:text-5xl lg:text-6xl">
              Reparaciones confiables para tu hogar
            </h1>
            <p className="max-w-xl text-lg text-text-light/80 dark:text-text-dark/80">
              Electricidad, plomería, pintura y mantenimiento general para hogares y pequeños negocios. 
              Soluciones rápidas y profesionales a tu alcance.
            </p>
          </div>
          <div className="flex flex-col gap-4 sm:flex-row">
            ...
            >
              ...
              <span className="truncate">Ver trabajos realizados</span>
            </Link>
          </div>
        </div>
